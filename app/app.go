...
import (
	...
	nftmodule "github.com/UptickNetwork/uptick/x/nft/module"
)
...
func (app *Uptick) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Uptick) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Uptick) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
