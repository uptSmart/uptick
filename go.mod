...
require (
	...
	// github.com/cosmos/ibc-go/v5 v3.1.0
...
require (
	...
	cloud.google.com/go/storage v1.14.0 // indirect; indirectx
...
replace (
	...
	github.com/cosmos/ibc-go/v5 => github.com/uptSmart/ibc-go/v5 v5.0.0-nft.0.20220914070057-1565d3da6e22
