...
|-----------------------------------|-------------------------------------------------------|------------|-----------------------------------------------|-----------------------------------------------------|
| uptick_7777-1 Testnet                | `uptick_{{ $themeConfig.project.testnet_chain_id }}-1` | `uptick`    | `{{ $themeConfig.project.testnet_chain_id }}` | `1`                                                 |
...
|----------------|------------|---------------|----------------|
| `uptick_7777-1` | uptick      | 7776          | 1              |
| `uptick_7777-1` | uptick      | 7776          | 2              |
| `...`          | ...        | ...           | ...            |
